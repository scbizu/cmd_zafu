...
const (
	...
	//首页地址
	logged_url string = "http://210.33.60.8/xs_main.aspx?xh=YourStudentNo"
	//默认登录页
	default_url string = "http://210.33.60.8/default2.aspx"
	//课程表
	courseURL string = "http://210.33.60.8/xskbcx.aspx?xh=YourStudentNo"
)
